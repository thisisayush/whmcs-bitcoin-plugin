(function () {
            ...
            if ($scope.order.status == -1) {
                ...
                ws.onmessage = function(evt) {
                    ...
                    $interval(function() {
                        ...
                        window.location = Url.get_whmcs_endpoint({'finish_order' : $scope.order_id});
    ...
    function Order($resource, Url) {
        var item = $resource(Url.get_whmcs_endpoint());
        return item;
    }
    ...
    function Url($httpParamSerializer) {
        ...
        service.get_whmcs_endpoint = function(new_params = {}) {
            var params = {};
