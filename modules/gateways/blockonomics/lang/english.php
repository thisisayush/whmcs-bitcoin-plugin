...
$_BLOCKLANG['error']['display']['title'] = 'Display Error';
$_BLOCKLANG['error']['display']['message'] = 'Unable to render correctly, Note to Administrator: Please enable lite mode in the Blockonomics plugin.';
$_BLOCKLANG['error']['addressGeneration']['title'] = 'Could not generate new Bitcoin address';
